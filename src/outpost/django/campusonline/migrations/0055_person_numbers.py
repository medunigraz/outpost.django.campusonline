# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2021-01-21 07:36
...
class Migration(migrations.Migration):
    ...
    ops = [
        ...
        (
            """
            ALTER FOREIGN TABLE "campusonline"."personen" ADD COLUMN PERS_FAX_NUMMER varchar;
            """,
            """
            ALTER FOREIGN TABLE "campusonline"."personen" DROP COLUMN PERS_FAX_NUMMER;
            """,
        ),
        (
            """
            ALTER FOREIGN TABLE "campusonline"."personen" ADD COLUMN PERS_EXTERNE_TELEFON_NUMMER varchar;
            """,
            """
            ALTER FOREIGN TABLE "campusonline"."personen" DROP COLUMN PERS_EXTERNE_TELEFON_NUMMER;
            """,
        ),
        (
            """
    ...
    dependencies = [("campusonline", "0054_person_card")]
