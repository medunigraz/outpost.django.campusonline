# Generated by Django 2.2.28 on 2023-03-14 08:52
...
class Migration(migrations.Migration):
    ...
    ops = [
        ...
        (
            """
            ALTER FOREIGN TABLE "campusonline"."personen"
                ADD COLUMN AKAD_GRAD_VOR varchar,
                ADD COLUMN AKAD_GRAD_NACH varchar,
                ADD COLUMN SONSTIGER_TITEL_VOR varchar,
                ADD COLUMN SONSTIGER_TITEL_NACH varchar,
                ADD COLUMN AMTSTITEL_vor varchar,
                ADD COLUMN AMTSTITEL_NACH varchar;
            """,
            """
            ALTER FOREIGN TABLE "campusonline"."personen"
                DROP COLUMN AKAD_GRAD_VOR,
                DROP COLUMN AKAD_GRAD_NACH,
                DROP COLUMN SONSTIGER_TITEL_VOR,
                DROP COLUMN SONSTIGER_TITEL_NACH,
                DROP COLUMN AMTSTITEL_VOR,
                DROP COLUMN AMTSTITEL_NACH;
            """,
        ),
        (
            """
            CREATE MATERIALIZED VIEW "public"."campusonline_person" AS SELECT
                ...
                HSTORE(
                    array['prefix', 'suffix'],
                    array[p.akad_grad_vor, p.akad_grad_nach]
                ) AS academic_title,
                HSTORE(
                    array['prefix', 'suffix'],
                    array[p.sonstiger_titel_vor, p.sonstiger_titel_nach]
                ) AS miscellaneous_title,
                HSTORE(
                    array['prefix', 'suffix'],
                    array[p.amtstitel_vor, p.amtstitel_nach]
                ) AS official_title
            FROM
                "campusonline"."personen" p
            LEFT JOIN
